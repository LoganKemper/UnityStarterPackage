...
namespace DigitalWorlds.StarterPackage3D
{
    ...
    {
        public enum FaceTargetType : byte
        {
            DontFace,
            FaceHorizontally,
            FaceDirectly
        ...
        private PatrolChase3D patrolChase;
        ...
        private void Start()
        {
            ...
            patrolChase = GetComponent<PatrolChase3D>();
        ...
        private void Update()
        {
            ...
            // If there's a PatrolChase3D component and it can't see the player, don't shoot
            if (patrolChase != null && !patrolChase.IsChasing)
            {
                return;
            }
