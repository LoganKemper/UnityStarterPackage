...
{
    /// <summary>
    /// Add to a player controller to interact with nearby objects.
    /// Intended for first-person controllers, but can work with other perspectives.
    /// </summary>
    public class RaycastInteractor : MonoBehaviour
    {
        ...
        [Tooltip("The input action used for interaction. Set to the E key by default.")]
        [SerializeField] private InputAction interactAction = new("Interaction", InputActionType.Button, "<Keyboard>/e");
        ...
        private void Interact()
        {
            ...
            if (Physics.Raycast(ray, out RaycastHit hit, interactDistance))
            {
                ...
                if (hit.collider.TryGetComponent<RaycastInteractable>(out var interactable))
                {
